        ...
        <div className="max-w-4xl mx-auto w-full space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-50 border border-slate-100 p-6 rounded-xl space-y-2 hover:border-[#c94b2b]/30 hover:shadow-md transition-all duration-300">
              ...
              <p className="text-slate-600 text-xs md:text-sm leading-relaxed font-medium">
                Compare over 20+ specialized international travel insurance policies simultaneously.
              </p>
            </div>

            <div className="bg-slate-50 border border-slate-100 p-6 rounded-xl space-y-2 hover:border-[#c94b2b]/30 hover:shadow-md transition-all duration-300">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">
                Instant Quote Aggregator
              </h3>
              <p className="text-slate-600 text-xs md:text-sm leading-relaxed font-medium">
                Input age and trip duration metrics to pull immediate market-rate assessments.
              </p>
            </div>

            <div className="bg-slate-50 border border-slate-100 p-6 rounded-xl space-y-2 hover:border-[#c94b2b]/30 hover:shadow-md transition-all duration-300">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">
                Independent Broker Oversight
              </h3>
              <p className="text-slate-600 text-xs md:text-sm leading-relaxed font-medium">
                Direct claims navigating support managed under the Sreem Client Group network.
              </p>
            </div>
          ...
          <div className="pt-6 flex justify-start">
            <a 
              ...
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-[#c94b2b] hover:bg-[#c94b2b]/5 text-[#c94b2b] font-bold text-xs uppercase tracking-wider rounded-lg transition-all hover:shadow-md transform hover:-translate-y-0.5"
            >
              Explore Complete Marketplace Directory ➔
            </a>
          </div>
